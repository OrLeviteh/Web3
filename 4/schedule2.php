...
$(document).ready(function () {
   ...
   $("ul.leftmenu li.mainLeaf li").hover(function () {
        isOk2SlideUp = false;
    }, function () {
        isOk2SlideUp = true;
    });
    ...
    $("ul.leftmenu li.mainLeaf").click(function () {
...
*/
	...
	<body>
		...
		<ul class="leftmenu">
                    <li class="mainLeaf">Industrial Design
                        <ul>
                            <li><a href="chair.html">Chair</a></li>
                            <li><a href="oficina.html">Oficina</a></li>
                            <li><a href="ace.html">Ace</a></li>
                            <li><a href="pencilcase.html">Pencil Case</a></li>
                            <li><a href="stool.html">Bookstool</a></li>
                            <li><a href="bigboy.html">Big Boy</a></li>
                            <li><a href="vase.html">Vase</a></li>
                            <li><a href="muji.html">Tax Return</a></li>
                            <li><a href="clark.html">Clark</a></li>
                        </ul>
                    </li>
                    <li class="mainLeaf">This&That
                        <ul>
                            <li><a href="stamp.html">PaperWeight</a></li>
                            <li><a href="greatwhite.html">Great White</a></li>
                            <li><a href="sheep.html">Sheep</a></li>
                            <li><a href="dukim.html">Dukim</a></li>
                            <li><a href="tape.html">Mix Tape</a></li>
                        </ul>
                    </li>
